...
#define LONGUEUR_AXE_X 520
#define LONGUEUR_AXE_Y 520
#define VALEUR_MIN_X "-1"
#define VALEUR_MAX_X "1"
#define VALEUR_MIN_Y "-1"
#define VALEUR_MAX_Y "1"
#define NB_GRADUATIONS 10
#define GAUCHE_PLAN 10
#define HAUT_PLAN 10
#define PADDING 10
...
int main(){
  ...
  MLV_create_window("test_taille", "[TEST]", 1200, 700);
  ...
  /*--Le cadre autour du plan--*/

  MLV_draw_rectangle(GAUCHE_PLAN - PADDING,
		     HAUT_PLAN - PADDING,
		     DROITE_PLAN +  PADDING,
  ...
  /*_____La graduation horizontale_____*/

  /*--initialisation des variables--*/
  taille_graduation= (DROITE_PLAN - GAUCHE_PLAN -20) / NB_GRADUATIONS;
  /*un decalage de -20 est pris en compte pour ne pas commencer la graduation au début de la ligne mais un peu après*/
  ...
  /*_____La graduation verticale_____*/
